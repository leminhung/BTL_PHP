                ...
                <nav style="margin: auto; color: orange !important;" class="col-4" aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php for ($i = 1; $i <= $so_trang; $i++) { ?>
                            <li class="page-item">
                                <a style="color: orange !important;" class="page-link" href="?trang=<?php echo $i ?>&categoryID=<?php if (isset($_GET['categoryId'])) echo $_GET['categoryId'] ?>&=<?php echo $search ?>"><?php echo $i ?>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
