    ...
    <div class="row header">
      ...
      <div class="row col-12 mb-3">
        <ul style="margin: auto;" class="nav ">
          <li class="nav-item">
            <a class="nav-link active nav-link-active-custom" href="./trangchu.html">Trang chủ</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active nav-link-active-custom" href="#">Về chúng tôi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active nav-link-active-custom" href="./index.html">Tất cả sản phẩm</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row col-12" style="padding-left: 0px;">
      <div class="col-3 justify-content-start" style="padding-left: 0px;">
        <div style="background-color: #333333 !important;" class="list-group list-group list-group-flush">
          ...
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY CỎ TỰ NHIÊN</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY CỎ NHÂN TẠO</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY FUTSAL</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH NIKE</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH ADIDAS</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH PUMA</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH MIZUNO</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH ASICS</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH KAMITO</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">GIÀY ĐÁ BANH TRẺ EM</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">QUẦN ÁO BÓNG ĐÁ</a>
          <a href="#" class="list-group-item list-group-item-action name-category-item">PHỤ KIỆN BÓNG ĐÁ</a>
        </div>
      </div>
      ...
      <div class="col-9 content">
        ...
        <div class="row list-product">
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">NIKE FOOTBALL FLIGHT PREMIER LEAGUE - WHITE/HYPER CRIMSON/BLACK</a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">ADIDAS X SPEEDFLOW .1 TF METEORITE - RED/CORE BLACK/SOLAR RED</a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">ADIDAS COPA SENSE .3 FG METEORITE - RED/FOOTWEAR WHITE/SOLAR RED</a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">ADIDAS COPA SENSE .3 TF METEORITE - RED/FOOTWEAR WHITE/SOLAR RED/PRO </a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">NIKE TIEMPO REACT LEGEND 9 CLUB TF - WHITE/DARK SMOKE GREY/BLACK/YELLOW</a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">ADIDAS X SPEEDFLOW .3 TF ESCAPELIGHT - CORE BLACK/SONIC INK/SOLAR YELLOW</a>
                <br>
                <span class="card-text old-price">1,900,000₫</span>
                <span class="card-text new-price"> 1,890,000₫</span>
              </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">BỌC ỐNG ĐỒNG ADIDAS X LESTO SHIN GUARDS - BLACK</a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">BỌC ỐNG ĐỒNG ADIDAS TIRO CLUB SHIN GUARDS - BLACK/WHITE</a>
                <br>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">BỘ QUẦN ÁO BÓNG ĐÁ KAMITO KMSH210250 TRẮNG VÀNG</a>
                <br>
                <span class="card-text old-price"></span>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6  ">
            <div style="margin-bottom: 10px !important;" class="card card-custom">
              ...
              <hr class="gach-ngang">
              <div style="padding: 0 1px !important;" class="card-body">
                <a class="card-title product-title" href="./chitiet.html">BỘ QUẦN ÁO BÓNG ĐÁ KAMITO KMSH210510 ĐỎ</a>
                <br>
                <span class="card-text old-price"></span>
                <span class="card-text new-price"> 199,000₫</span>
              </div>
        ...
        <nav style="margin: auto; color: orange !important;" class="col-4" aria-label="Page navigation example">
          <ul class="pagination">
            ...
            <li class="page-item"><a style="color: orange !important;" class="page-link" href="#">Next</a></li>
          </ul>
        </nav>
      </div>
    </div>
