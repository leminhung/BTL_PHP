    ...
    <div style=" max-width: 1350px; margin-top: 154px;" class="container">
        <div class="row col-12" style="padding-left: 0px;">
            ...
            if (isset($_GET['categoryId'])) {
                ...
                $sql = "SELECT * FROM products
                    WHERE
                    UPPER(product_name) REGEXP BINARY '^$search'
                    LIMIT $so_san_pham_tren_1_trang offset $boqua";
            }
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6  ">
                                <div style="margin-bottom: 10px !important;" class="card card-custom">
                                    ...
                                    <div style="padding: 0 1px !important;" class="card-body">
                                        <a class="card-title product-title" href="./chitiet.php"><?php echo $product['product_name'] ?></a>
                                        <br>
                                        <div class="price">
                ...
                <nav style="margin: auto; color: orange !important;" class="col-4" aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php for ($i = 1; $i <= $so_trang; $i++) { ?>
                            <li class="page-item"><a style="color: orange !important;" class="page-link" href="?trang=<?php echo $i ?>&timkiem=<?php echo $search ?>"><?php echo $i ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                </nav>
