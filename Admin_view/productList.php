                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-danger" href="./product/delete_product.php?id=<?php echo $row_product['product_id'] ?>" onclick="return confirm('Bạn có muốn xóa <?php echo $row_product['product_name'] ?>?')" role="button">Delete</a>
                    </td>
                  </tr>
