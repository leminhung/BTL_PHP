   ...
   <!-- NAVIGATION -->
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
         ...
         <div class="container-fluid">
                    ...
                    <form class="form-inline" action="${base }/admin/saleOrderList" method="get">
							...
							<tbody>
								<c:forEach items="${saleOrderWithPaging.data}" var="so" varStatus="loop">
									<tr>
										...
										<td>
											<a role="button" class="btn btn-primary" href="./saleOrderDetail.html"><i class="fas fa-info-circle"></i> Detail</a>
											
											<a class="btn btn-danger" href="${base }/admin/saleOrderList/delete/${so.id}" role="button">Delete</a>	
										</td>
									</tr>
								</c:forEach>
