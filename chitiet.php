...
<body>
    ...
    <div class="container-fluid">
            ...
            <div class="row head  ">
                <div class="col-12 nav-item dropdown nav-custom">
                    ...
                    <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item dropdown-item-custom" href="#">Đăng nhập</a>
                        <div class="dropdown-divider margin: 3px 0;"></div>
        ...
        <div style="margin-top: 154px;" class="container">
            <div class="row">
                <div class="col-4">
                    <img width="350px" heigh="350px" src="./product img/ADIDAS COPA SENSE .3 FG .jpg" alt="">
                </div>

                <div class="col-8">
                    <p class="name-product">ADIDAS COPA SENSE .3 TF METEORITE - RED/FOOTWEAR WHITE/SOLAR RED/PRO</p>
                    <span class="card-text old-price">1,900,000₫</span>
                    <span class="card-text new-price"> 1,890,000₫</span>
                    <p class="name-provider">Nhà cung cấp: Adidas</p>
                    <dl>
                    ...
                    <p style="font-size: 26px; color: red; font-weight: 600;">Cam kết chính hãng 100%. Bồi hoàn gấp 10
                        lần nếu không phải là hàng chính hãng</p>
